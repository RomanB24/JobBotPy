...
class PostgresqlDBManagementSystem(object):
    """Питоновский класс с postgresql"""
    ...
    def __new__(cls, *args, **kwargs):
        if not cls.__instance or not cls.__database:
            cls.__instance = super(PostgresqlDBManagementSystem, cls).__new__(cls)
    ...
    def __open(self):
        ...
        try:
            self.__connection = psycopg2.connect("dbname='{0}' user='{1}' password='{2}'".
                                                 format(self.__database, self.__user, self.__password))
